...
class CreateVocationalTrainingSkillsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vocational_training_skills', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('vocational_training_skills');
    }
}
