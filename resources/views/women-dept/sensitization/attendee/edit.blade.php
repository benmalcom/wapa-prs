    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line breadcrumb-line-component">
            <ul class="breadcrumb">
                ...
                <li class="active">{{ $sensitization->title }}</li>
            </ul>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                {!! Form::model($attendee, array('route' => ['sensitizations.attendees.update', $sensitization->id, $attendee->id], 'method'=>'PUT', 'class' => 'form-horizontal')) !!}
