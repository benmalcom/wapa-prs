    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Edit Women Group</h5>
            </div>

            <div class="panel-body">

                {!! Form::model($womenCooperativeSociety, ['method' => 'PUT','route' => ['cooperative-societies.update', $womenCooperativeSociety->id], 'class' => 'form-horizontal']) !!}

                <fieldset class="content-group">
                    <div class="form-group">
                        <label class="control-label col-lg-2">Name</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" required value="{{ $womenCooperativeSociety->name }}" placeholder="Society/Group Name" name="name">
                        </div>
                    </div>
